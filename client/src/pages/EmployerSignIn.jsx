            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-4 bg-white text-[#6B7280] font-normal">Or continue with email</span>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="text-right mt-2">
                  <button type="button" className="text-sm text-[#1E3A8A] font-semibold hover:underline">
                    Forgot password?
                  </button>
                </div>
              </div>
