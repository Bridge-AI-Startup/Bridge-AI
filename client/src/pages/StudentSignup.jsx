...
export default function StudentSignup() {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      console.log("Student signup:", { fullName, email });
      navigate("/Onboarding");
    }, 1000);
  };

  const handleGoogleSignup = () => {
    console.log("Google signup: student");
    // In production, this would trigger Google OAuth
    alert("Google sign-up would be triggered here. After authentication, you'd go to onboarding.");
    setTimeout(() => {
      navigate("/Onboarding");
    }, 500);
  };

  const canSubmit = fullName && email && password && confirmPassword && password === confirmPassword;

  return (
    <div className="min-h-screen bg-white">
      <Header currentPage="StudentSignup" />
          ...
          >
            ...
            <div>
              ...
              <Input
                ...
                required
              />
              <p className="text-xs text-[#6B7280] mt-1 font-normal">Must be a .edu email</p>
            </div>
